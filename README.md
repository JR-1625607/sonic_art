...
I was unable to attend the lecture this week due to illness, However, I have been working on my webpage and have sent it through to Krisztian for feedback. After inserting my header image into my webpage last week I wanted to finish the design aspect of the page this week. To start I pasted in my abstract I had previously written into the page, I wasn’t happy with the layout of the text so I used align="center" to center certain parts of my text in order to make them stand out. Once I was happy with the text layout I used iMovie to combine the rough draft of my soundscape with the background image I created last week. I uploaded it and then used YouTube embed function to embed it into my page. I ran in to problem where the YouTube video would align itself to the rough if the page which doesn’t match the centered theme of my page. To fix this I added center at the beginning and end of the iframe, which solved the problem. After receiving feedback via email from the class, I set about to change the issues they had brought up, both in the text and the soundscape. I decided to fix the sound problems first, which were shortening some part and lengthening others, and also boosting the voices so they can be heard. I war anticipating there to be some issues with the audio because the version I sent was a rough draft with no audio editing. After this I edited the writing on the page, removing some parts and changing words, such as making some parts past tense. 
